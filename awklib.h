...
#define AWK_WM_ICONNOTIFY (WM_APP + 1)
#define AWK_GUID_NOTIFICATIONICON { 0x8F3C8D04, 0xE22B, 0x4683, {0xB4, 0xE6, 0x0F, 0x61, 0xD1, 0xF2, 0xE1, 0x19} }
...
namespace AWKYDO {
	...
	namespace Window {
		...
		static TCHAR sWindowClassName[] = L"AWKYDO_Overlay";
	}
}